...
TARGET_BOOTLOADER_CONFIG := imx8mn-ddr4:imx8mn_ddr4_sva500_android_defconfig
...
TARGET_BOOTLOADER_CONFIG += imx8mn-ddr4-evk-uuu:imx8mn_ddr4_sva500_android_uuu_defconfig
#TARGET_BOOTLOADER_CONFIG += imx8mn-evk-uuu:imx8mn_evk_android_uuu_defconfig

ifeq ($(IMX8MN_USES_GKI),true)
TARGET_KERNEL_DEFCONFIG := gki_defconfig
TARGET_KERNEL_GKI_DEFCONF := sva500_gki.fragment
else
