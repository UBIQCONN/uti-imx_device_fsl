...
BOARD_PREBUILT_DTBOIMAGE := $(OUT_DIR)/target/product/$(PRODUCT_DEVICE)/dtbo-imx8mn-ddr4-mipi-panel.img
...
# display config
BOARD_KERNEL_CMDLINE += androidboot.lcd_density=120 androidboot.primary_display=imx-drm
...
ifeq ($(TARGET_USE_DYNAMIC_PARTITIONS),true)
  ifeq ($(IMX_NO_PRODUCT_PARTITION),true)
    ...
    TARGET_BOARD_DTS_CONFIG += imx8mn-ddr4-mipi-panel:imx8mn-ddr4-evk-voip.dtb
